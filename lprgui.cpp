...
//get printers
	...
	QObject::connect(plist,QOverload<int>::of(&QComboBox::activated),[&defaultSize,&paperSizes](int index)
		{
			paperSizes.clear();
...
//print
	...
	QObject::connect(printTheFiles,&QPushButton::clicked,[&printFiles,&filenames,&quality,&customOptions,&copies]()
		{
			QStringList args;
